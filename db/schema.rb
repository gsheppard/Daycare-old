...
ActiveRecord::Schema.define(version: 20140310001008) do
  ...
  create_table "ability_prose", primary_key: "ability_id", force: true do |t|
    t.integer "local_language_id",              null: false
    t.string  "effect",            limit: 5120
    t.string  "short_effect",      limit: 512
  end
  ...
  create_table "conquest_kingdoms", force: true do |t|
    t.string  "identifier", limit: 9, null: false
  ...
  create_table "conquest_move_displacement_prose", primary_key: "move_displacement_id", force: true do |t|
    ...
    t.string  "short_effect",      limit: 128
    t.string  "effect",            limit: 256
  end
  ...
  create_table "conquest_move_displacements", force: true do |t|
    t.string  "identifier",     limit: 18, null: false
  ...
  create_table "conquest_move_effect_prose", primary_key: "conquest_move_effect_id", force: true do |t|
    t.integer "local_language_id",              null: false
    t.string  "short_effect",      limit: 256
    t.string  "effect",            limit: 5120
  end
  ...
  create_table "conquest_stats", force: true do |t|
    t.string  "identifier", limit: 7, null: false
  ...
  create_table "conquest_warrior_archetypes", force: true do |t|
    t.string "identifier", limit: 15, null: false
  end
  ...
  create_table "item_flavor_summaries", primary_key: "item_id", force: true do |t|
    t.integer "local_language_id",             null: false
    t.string  "flavor_summary",    limit: 512
  end
  ...
  create_table "move_effect_changelog_prose", primary_key: "move_effect_changelog_id", force: true do |t|
    t.integer "local_language_id",             null: false
    t.string  "effect",            limit: 512, null: false
  end
  ...
  add_index "move_meta", ["recoil"], name: "ix_move_meta_recoil"
  ...
  create_table "pokemon_form_names", primary_key: "pokemon_form_id", force: true do |t|
    ...
    t.string  "pokemon_name",      limit: 32
  end
  ...
  create_table "pokemon_forms", force: true do |t|
    t.string  "identifier",                     limit: 30, null: false
    t.string  "form_identifier",                limit: 16
    t.integer "pokemon_id",                                null: false
  ...
  create_table "pokemon_shape_prose", primary_key: "pokemon_shape_id", force: true do |t|
    t.integer "local_language_id",            null: false
    t.string  "name",              limit: 24
    t.string  "awesome_name",      limit: 16
  end
  ...
  create_table "pokemon_species_prose", primary_key: "pokemon_species_id", force: true do |t|
    t.integer "local_language_id",              null: false
    t.string  "form_description",  limit: 1024
  end
  ...
  add_index "pokemons", ["is_default"], name: "ix_pokemon_is_default"
  add_index "pokemons", ["order"], name: "ix_pokemon_order"
  ...
  create_table "stat_hint_names", primary_key: "stat_hint_id", force: true do |t|
    t.integer "local_language_id",            null: false
    t.string  "message",           limit: 24, null: false
  end

  add_index "stat_hint_names", ["message"], name: "ix_stat_hint_names_message"
  add_index "stat_hint_names", ["stat_hint_id", "local_language_id"], name: "sqlite_autoindex_stat_hint_names_1", unique: true

  create_table "stat_hints", force: true do |t|
    t.integer "stat_id",    null: false
    t.integer "gene_mod_5", null: false
  end

  add_index "stat_hints", ["gene_mod_5"], name: "ix_stat_hints_gene_mod_5"
  ...
  create_table "types", force: true do |t|
    t.string  "identifier",      limit: 12, null: false
    t.integer "generation_id",              null: false
    t.integer "damage_class_id"
  end
